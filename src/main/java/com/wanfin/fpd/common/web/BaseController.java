...
//			}
    ...
    protected Response resCreated(Link res) {
        return Response.created(URI.create((String)res.get(JKey.HREF))).entity(res).build();
    }
    
    protected void responseData_html(String data, HttpServletResponse response) {
