...
public class JsonOUtils {
    ...
    */
   @SuppressWarnings("unchecked")
	public static Map<Object, Object> parseJSON2Map(Object jsonStr) {
     ...
     */
    @SuppressWarnings("unchecked")
	public  static <T>  T parseJSON2Bean(Object jsonObj, Class<T> type) {
     ...
     * @throws JSONException
     */
    public static void toJavaBean(Object javabean, JSONObject jsonObject)
            throws JSONException {
    ...
    /**
     * 把json对象转换成一行字符串。
     * @param json 可以是：JSONObject、JSONArray、json格式的字符串
     * @return
     */
