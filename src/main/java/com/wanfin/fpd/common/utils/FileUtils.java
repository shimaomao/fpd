...
public class FileUtils extends org.apache.commons.io.FileUtils {
	 ...
	 * @throws IOException
	 */
	public static InputStream getFileInputStream(String httpPath) throws IOException{
		return getFileHttpURLConnection(httpPath).getInputStream();
	}
	public static HttpURLConnection getFileHttpURLConnection(String httpPath) throws IOException{
