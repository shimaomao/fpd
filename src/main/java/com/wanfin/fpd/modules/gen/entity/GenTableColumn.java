 ...
 */
package com.wanfin.fpd.modules.gen.entity;
...
public class GenTableColumn extends DataEntity<GenTableColumn> {
	...
	private String isQueryBy;	// 是否By查询字段（1：查询字段）
	private String queryByType;	// 查询方式（等于、不等于、大于、小于、范围、左LIKE、右LIKE、左右LIKE）
	private String isApi;		// 是否API字段（1：API字段）
	private String isApiInsert;	// 是否API插入字段（1：API插入字段）
	private String isApiQuery;	// 是否API查询字段（1：API查询字段）
	...
	public String getIsQueryBy() {
		return isQueryBy;
	}

	public void setIsQueryBy(String isQueryBy) {
		this.isQueryBy = isQueryBy;
	}
	...
	public String getIsApiInsert() {
		return isApiInsert;
	}

	public void setIsApiInsert(String isApiInsert) {
		this.isApiInsert = isApiInsert;
	}

	public String getIsApiQuery() {
		return isApiQuery;
	}

	public void setIsApiQuery(String isApiQuery) {
