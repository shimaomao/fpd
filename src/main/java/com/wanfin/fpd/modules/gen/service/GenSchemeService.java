...
import com.wanfin.fpd.modules.gen.dao.GenSchemeDao;
import com.wanfin.fpd.modules.gen.dao.GenTableColumnDao;
import com.wanfin.fpd.modules.gen.dao.GenTableDao;
import com.wanfin.fpd.modules.gen.entity.GenConfig;
...
//	private GenTemplateDao genTemplateDao;
	...
	public Page<GenScheme> find(Page<GenScheme> page, GenScheme genScheme) {
		...
		genScheme.getSqlMap().put("dsf", dataScopeFilter(UserUtils.getUser().getCurrentUser(), "o", "u"));
	 ...
	 * @return
	 */
	public List<GenScheme> findListByCategory(String category, GenScheme entity) {
		if(StringUtils.isNotEmpty(category)){
			if(entity == null){
				entity = new GenScheme();
			}
			entity.setCategory(category);
			return genSchemeDao.findListByCategory(entity);
		}
		return new ArrayList<GenScheme>();
	}
}
