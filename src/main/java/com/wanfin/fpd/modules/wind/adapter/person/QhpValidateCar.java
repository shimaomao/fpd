 ...
 * @version 2016-06-08
 */
public class QhpValidateCar implements IAdapter<QhpValidateCar>{
	private enum CEnum{
	...
	@Override
	public List<QhpValidateCar> init(JSONArray jarray) throws JSONException {
		List<QhpValidateCar> entitys = new ArrayList<QhpValidateCar>();
	...
	@Override
	public QhpValidateCar init(String data) throws JSONException {
		return init(new JSONObject(data));
	}

	private QhpValidateCar init(JSONObject jo) throws JSONException {
		QhpValidateCar entity = new QhpValidateCar();
	...
	private List<CMap> initCmaps(QhpValidateCar entity) {
