 ...
 * @version 2016-06-08
 */
public class QhpValidateDZ implements IAdapter<QhpValidateDZ>{
	private enum CEnum{
	...
	@Override
	public List<QhpValidateDZ> init(JSONArray jarray) throws JSONException {
		List<QhpValidateDZ> entitys = new ArrayList<QhpValidateDZ>();
	...
	@Override
	public QhpValidateDZ init(String data) throws JSONException {
		return init(new JSONObject(data));
	}

	private QhpValidateDZ init(JSONObject jo) throws JSONException {
		QhpValidateDZ entity = new QhpValidateDZ();
	...
	private List<CMap> initCmaps(QhpValidateDZ entity) {
