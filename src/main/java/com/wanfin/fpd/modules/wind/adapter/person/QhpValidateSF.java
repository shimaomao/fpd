 ...
 * @version 2016-06-08
 */
public class QhpValidateSF implements IAdapter<QhpValidateSF>{
	private enum CEnum{
	...
	@Override
	public List<QhpValidateSF> init(JSONArray jarray) throws JSONException {
		List<QhpValidateSF> entitys = new ArrayList<QhpValidateSF>();
	...
	@Override
	public QhpValidateSF init(String data) throws JSONException {
		return init(new JSONObject(data));
	}

	private QhpValidateSF init(JSONObject jo) throws JSONException {
		QhpValidateSF entity = new QhpValidateSF();
	...
	private List<CMap> initCmaps(QhpValidateSF entity) {
