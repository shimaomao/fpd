 ...
 * @version 2016-06-08
 */
public class QhpValidateEducation implements IAdapter<QhpValidateEducation>{
	private enum CEnum{
	...
	@Override
	public List<QhpValidateEducation> init(JSONArray jarray) throws JSONException {
		List<QhpValidateEducation> entitys = new ArrayList<QhpValidateEducation>();
	...
	@Override
	public QhpValidateEducation init(String data) throws JSONException {
		return init(new JSONObject(data));
	}

	private QhpValidateEducation init(JSONObject jo) throws JSONException {
		QhpValidateEducation entity = new QhpValidateEducation();
	...
	private List<CMap> initCmaps(QhpValidateEducation entity) {
