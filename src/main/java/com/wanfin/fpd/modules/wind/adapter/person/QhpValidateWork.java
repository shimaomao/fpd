 ...
 * @version 2016-06-08
 */
public class QhpValidateWork implements IAdapter<QhpValidateWork>{
	private enum CEnum{
	...
	@Override
	public List<QhpValidateWork> init(JSONArray jarray) throws JSONException {
		List<QhpValidateWork> entitys = new ArrayList<QhpValidateWork>();
	...
	@Override
	public QhpValidateWork init(String data) throws JSONException {
		return init(new JSONObject(data));
	}

	private QhpValidateWork init(JSONObject jo) throws JSONException {
		QhpValidateWork entity = new QhpValidateWork();
	...
	private List<CMap> initCmaps(QhpValidateWork entity) {
