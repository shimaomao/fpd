 ...
 * @version 2016-06-08
 */
public class QhpRentCar implements IAdapter<QhpRentCar>{
	private enum CEnum{
		//id, personid, resId, seqNo, idno, idtype, name, erCode, erMsg, office;
	...
	@Override
	public List<QhpRentCar> init(JSONArray jarray) throws JSONException {
		List<QhpRentCar> entitys = new ArrayList<QhpRentCar>();
	...
	@Override
	public QhpRentCar init(String data) throws JSONException {
		return init(new JSONObject(data));
	}

	private QhpRentCar init(JSONObject jo) throws JSONException {
		QhpRentCar entity = new QhpRentCar();
	...
	private List<CMap> initCmaps(QhpRentCar entity) {
