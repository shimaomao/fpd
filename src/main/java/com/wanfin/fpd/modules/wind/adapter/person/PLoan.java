 ...
 * @version 2016-05-16
 */
public class PLoan implements IAdapter<PLoan>{
	private enum CEnum{
//		id, personid, financeagency, amount, startdate, enddate, reason, iswarrant, warrantentitytype, warrantentityid, isclear, isdelay, isdispute; 
		id("id", "主键"),
	...
	@Override
	public List<PLoan> init(JSONArray jarray) throws JSONException {
		List<PLoan> entitys = new ArrayList<PLoan>();
	...
	@Override
	public PLoan init(String data) throws JSONException {
		return init(new JSONObject(data));
	}
	
	private PLoan init(JSONObject jo) throws JSONException {
		PLoan entity = new PLoan();
	...
	private List<CMap> initCmaps(PLoan entity) {
