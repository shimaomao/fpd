 ...
 * @version 2016-06-08
 */
public class QhpValidateHouse implements IAdapter<QhpValidateHouse>{
	private enum CEnum{
	...
	@Override
	public List<QhpValidateHouse> init(JSONArray jarray) throws JSONException {
		List<QhpValidateHouse> entitys = new ArrayList<QhpValidateHouse>();
	...
	@Override
	public QhpValidateHouse init(String data) throws JSONException {
		return init(new JSONObject(data));
	}

	private QhpValidateHouse init(JSONObject jo) throws JSONException {
		QhpValidateHouse entity = new QhpValidateHouse();
	...
	private List<CMap> initCmaps(QhpValidateHouse entity) {
