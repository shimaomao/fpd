 ...
 * @version 2016-06-08
 */
public class QhpValidatePhone implements IAdapter<QhpValidatePhone>{
	private enum CEnum{
	...
	@Override
	public List<QhpValidatePhone> init(JSONArray jarray) throws JSONException {
		List<QhpValidatePhone> entitys = new ArrayList<QhpValidatePhone>();
	...
	@Override
	public QhpValidatePhone init(String data) throws JSONException {
		return init(new JSONObject(data));
	}

	private QhpValidatePhone init(JSONObject jo) throws JSONException {
		QhpValidatePhone entity = new QhpValidatePhone();
	...
	private List<CMap> initCmaps(QhpValidatePhone entity) {
