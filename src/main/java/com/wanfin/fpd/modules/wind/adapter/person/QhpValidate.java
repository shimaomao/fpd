 ...
 * @version 2016-06-08
 */
public class QhpValidate implements IAdapter<QhpValidate>{
	private enum CEnum{
	...
	@Override
	public List<QhpValidate> init(JSONArray jarray) throws JSONException {
		List<QhpValidate> entitys = new ArrayList<QhpValidate>();
	...
	@Override
	public QhpValidate init(String data) throws JSONException {
		return init(new JSONObject(data));
	}

	private QhpValidate init(JSONObject jo) throws JSONException {
		QhpValidate entity = new QhpValidate();
	...
	private List<CMap> initCmaps(QhpValidate entity) {
