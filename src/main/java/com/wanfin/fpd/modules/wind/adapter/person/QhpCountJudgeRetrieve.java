 ...
 * @version 2016-06-08
 */
public class QhpCountJudgeRetrieve implements IAdapter<QhpCountJudgeRetrieve>{
	private enum CEnum{
	...
	@Override
	public List<QhpCountJudgeRetrieve> init(JSONArray jarray) throws JSONException {
		List<QhpCountJudgeRetrieve> entitys = new ArrayList<QhpCountJudgeRetrieve>();
	...
	@Override
	public QhpCountJudgeRetrieve init(String data) throws JSONException {
		return init(new JSONObject(data));
	}

	private QhpCountJudgeRetrieve init(JSONObject jo) throws JSONException {
		QhpCountJudgeRetrieve entity = new QhpCountJudgeRetrieve();
	...
	private List<CMap> initCmaps(QhpCountJudgeRetrieve entity) {
