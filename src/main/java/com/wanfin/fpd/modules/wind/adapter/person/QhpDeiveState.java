 ...
 * @version 2016-06-08
 */
public class QhpDeiveState implements IAdapter<QhpDeiveState>{
	private enum CEnum{
	...
	@Override
	public List<QhpDeiveState> init(JSONArray jarray) throws JSONException {
		List<QhpDeiveState> entitys = new ArrayList<QhpDeiveState>();
	...
	@Override
	public QhpDeiveState init(String data) throws JSONException {
		return init(new JSONObject(data));
	}

	private QhpDeiveState init(JSONObject jo) throws JSONException {
		QhpDeiveState entity = new QhpDeiveState();
	...
	private List<CMap> initCmaps(QhpDeiveState entity) {
