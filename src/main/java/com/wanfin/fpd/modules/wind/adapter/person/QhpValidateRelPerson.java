 ...
 * @version 2016-06-08
 */
public class QhpValidateRelPerson implements IAdapter<QhpValidateRelPerson>{
	private enum CEnum{
	...
	@Override
	public List<QhpValidateRelPerson> init(JSONArray jarray) throws JSONException {
		List<QhpValidateRelPerson> entitys = new ArrayList<QhpValidateRelPerson>();
	...
	@Override
	public QhpValidateRelPerson init(String data) throws JSONException {
		return init(new JSONObject(data));
	}

	private QhpValidateRelPerson init(JSONObject jo) throws JSONException {
		QhpValidateRelPerson entity = new QhpValidateRelPerson();
	...
	private List<CMap> initCmaps(QhpValidateRelPerson entity) {
