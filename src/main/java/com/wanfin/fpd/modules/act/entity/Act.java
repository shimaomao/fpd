 ...
 */
package com.wanfin.fpd.modules.act.entity;
...
import com.wanfin.fpd.modules.act.utils.Variable;
...
//	private Variable taskVars; 	// 流程任务变量
	...
	private String isEnd;//是否为最后节点  
	
	private String customerId;		// 客户id#4413添加
	private String customerName;		// 客户姓名#4413添加
	private String productId;		// 产品主键#4413添加
	private String productname;		// 产品名称#4413添加
	private String activityName;	//执行环节
	private String startTime;	//开始时间  接口用 2017-04-10
	private String endTime;	//结束时间  接口用 2017-04-10
...
//	}
	...
	public String getProcDefKey() {
		if (StringUtils.isBlank(procDefKey)){
			...
			} else if(StringUtils.isNotBlank(procDefId)){
	...
	public String getDurationTime(){
		if (histIns!=null && histIns.getDurationInMillis() != null){
			String durationtime = TimeUtils.toTimeString(histIns.getDurationInMillis());
			if("23时59分59秒".equals(durationtime)&&histIns.getEndTime().compareTo(histIns.getStartTime())==0){
				durationtime = "0";
			}
			return durationtime;
		}
