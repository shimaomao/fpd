 ...
 */
package com.wanfin.fpd.modules.act.utils;
...
import com.wanfin.fpd.common.annotation.FieldName;
import com.wanfin.fpd.common.config.Global;
import com.wanfin.fpd.common.utils.Encodes;
import com.wanfin.fpd.common.utils.ObjectUtils;
...
//	}
	...
	public static String getFormUrl(String formKey, Act act){
		...
		formUrl.append("&act.businessTable=").append(act.getBusinessTable() != null ? act.getBusinessTable() : "");
	...
	/**
	 * 获取流程表单URL 
	 * 这里RUL里面的参数名称与上面那个不同，不是以act.开头的
	 * @Description TODO
	 * @param formKey
	 * @param act 表单传递参数
	 * @return
	 * @author zzm 
	 * @date 2016-3-30 下午6:26:21  
	 */
	public static String getFormUrl2(String formKey, Act act){
		...
		formUrl.append("&businessId=").append(act.getBusinessId() != null ? act.getBusinessId() : "");
		formUrl.append("&businessTable=").append(act.getBusinessTable() != null ? act.getBusinessTable() : "");
		formUrl.append("&id=").append(act.getBusinessId() != null ? act.getBusinessId() : "");
