...
/**
 * 
 * @Description 解除黑名单-任务监听事件，执行流程任务过程中的添加相应的业务逻辑
 * @author zzm
 * @date 2016-6-24 下午5:24:34 
 */
public class BlackRemoveTaskListener implements Serializable, TaskListener {
	...
	public void notify(DelegateTask delegateTask) {
		System.out.println("----任务监听   BlackRemoveTaskListener---");
