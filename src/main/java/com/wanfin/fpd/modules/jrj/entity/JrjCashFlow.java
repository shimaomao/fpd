 ...
 * @version 2016-11-13
 */
public class JrjCashFlow extends DataEntity<JrjCashFlow> {
	...
	private String row37One;		// row37_one
	private String row37Two;		// row37_two
	private String row38One;		// row38_one
	private String row38Two;		// row38_two	
	private String row39One;		// row39_one
	private String row39Two;		// row39_two
	private String row40One;		// row40_one
	private String row40Two;		// row40_two
	...
	public String getRow40One() {
		return row40One;
	}

	public void setRow40One(String row40One) {
		this.row40One = row40One;
	}

	public String getRow40Two() {
		return row40Two;
	}

	public void setRow40Two(String row40Two) {
		this.row40Two = row40Two;
	}
	...
	public String senData(){
		if("1".equals(this.getDelFlag())){ //删除数据
    		return "D" + "|" + this.getCompanyName() + "|" +this.getReportName()+"|"
    			    ...
    			    + this.getRow36One() +"|" + this.getRow36Two() +"|"
    			    + this.getRow37One() +"|" + this.getRow37Two() +"|"
    			    + this.getRow38One() +"|" + this.getRow38Two() +"|"
    			    + this.getRow39One() +"|" + this.getRow39Two() +"|"
    			    + this.getRow40One() +"|" + this.getRow40Two() +"|"    			    
