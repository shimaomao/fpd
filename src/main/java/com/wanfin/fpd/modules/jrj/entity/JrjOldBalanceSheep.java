 ...
 * @version 2016-05-17
 */
public class JrjOldBalanceSheep extends DataEntity<JrjOldBalanceSheep> {
	...
	private String row34One;		
	private String row34Two;		
	private String row34Three;
	private String row34Four;
	
	private String row35One;		
	private String row35Two;		
	private String row35Three;
	private String row35Four;
	
	private String row36One;		
	private String row36Two;		
	private String row36Three;
	private String row36Four;
	
	private String row37One;		
	private String row37Two;		
	private String row37Three;
	private String row37Four;
	
	private String row38One;		
	private String row38Two;		
	private String row38Three;
	private String row38Four;
	
	private String row39One;		
	private String row39Two;		
	private String row39Three;
	private String row39Four;
	...
	public String getRow37One() {
		return row37One;
	}

	public void setRow37One(String row37One) {
		this.row37One = row37One;
	}

	public String getRow37Two() {
		return row37Two;
	}

	public void setRow37Two(String row37Two) {
		this.row37Two = row37Two;
	}

	public String getRow37Three() {
		return row37Three;
	}

	public void setRow37Three(String row37Three) {
		this.row37Three = row37Three;
	}

	public String getRow37Four() {
		return row37Four;
	}

	public void setRow37Four(String row37Four) {
		this.row37Four = row37Four;
	}
	...
	public String getRow38One() {
		return row38One;
	}

	public void setRow38One(String row38One) {
		this.row38One = row38One;
	}

	public String getRow38Two() {
		return row38Two;
	}

	public void setRow38Two(String row38Two) {
		this.row38Two = row38Two;
	}

	public String getRow38Three() {
		return row38Three;
	}

	public void setRow38Three(String row38Three) {
		this.row38Three = row38Three;
	}

	public String getRow38Four() {
		return row38Four;
	}

	public void setRow38Four(String row38Four) {
		this.row38Four = row38Four;
	}

	public String getRow39One() {
		return row39One;
	}

	public void setRow39One(String row39One) {
		this.row39One = row39One;
	}

	public String getRow39Two() {
		return row39Two;
	}

	public void setRow39Two(String row39Two) {
		this.row39Two = row39Two;
	}

	public String getRow39Three() {
		return row39Three;
	}

	public void setRow39Three(String row39Three) {
		this.row39Three = row39Three;
	}

	public String getRow39Four() {
		return row39Four;
	}

	public void setRow39Four(String row39Four) {
		this.row39Four = row39Four;
	}
	...
	public String senData(){
		if("1".equals(this.getDelFlag())){ //删除数据
    		return "D" + "|" + this.getCompanyName() + "|" +this.getReportName()+"|"
    			    ...
    			    + this.getRow34One() +"|" + this.getRow34Two() +"|" + this.getRow34Three()  + "|" + this.getRow34Four() + "|"
    			    + this.getRow35One() +"|" + this.getRow35Two() +"|" + this.getRow35Three()  + "|" + this.getRow35Four() + "|"
    			    + this.getRow36One() +"|" + this.getRow36Two() +"|" + this.getRow36Three()  + "|" + this.getRow36Four() + "|"
    			    + this.getRow37One() +"|" + this.getRow37Two() +"|" + this.getRow37Three()  + "|" + this.getRow37Four() + "|"
    			    + this.getRow38One() +"|" + this.getRow38Two() +"|" + this.getRow38Three()  + "|" + this.getRow38Four() + "|"
    			    + this.getRow39One() +"|" + this.getRow39Two() +"|" + this.getRow39Three()  + "|" + this.getRow39Four() + "|"
