...
@ApiIgnore
@Controller
@RequestMapping(value = "${adminPath}/profit/jrjProfit")
public class JrjProfitController extends BaseController {

	@Autowired
	private JrjProfitService jrjProfitService;
	
	@ModelAttribute
	public JrjProfit get(@RequestParam(required=false) String id) {
		JrjProfit entity = null;
		if (StringUtils.isNotBlank(id)){
			entity = jrjProfitService.get(id);
		}
		if (entity == null){
			entity = new JrjProfit();
		}
		return entity;
	}
	
	@RequestMapping(value = {"list", ""})
	public String list(JrjProfit jrjProfit, HttpServletRequest request, HttpServletResponse response, Model model) {
		Page<JrjProfit> page = jrjProfitService.findPage(new Page<JrjProfit>(request, response), jrjProfit); 
		String  first = "";
		...
		return "modules/jrj/tProfitList";
	}

	@RequestMapping(value = "form")
	public String form(JrjProfit jrjProfit, Model model) {
		...
		model.addAttribute("jrjProfit", jrjProfit);
		return "modules/jrj/tProfitForm";
	}

	@RequestMapping(value = "save")
	public String save(JrjProfit jrjProfit, Model model, RedirectAttributes redirectAttributes) {
		...
		return "redirect:"+Global.getAdminPath()+"/profit/jrjProfit/?repage";
	}
	
	@RequestMapping(value = "delete")
	public String delete(JrjProfit jrjProfit, RedirectAttributes redirectAttributes) {
