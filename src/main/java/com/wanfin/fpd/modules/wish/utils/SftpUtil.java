...
public class SftpUtil {
     ...
     * 文件路径前缀. /ddit-remote 
     */  
    private static final String PRE_FIX = "/upload";  
    ...
    public static File download(final String downloadFile, final String saveFile, final ChannelSftp sftp)
        ...
        try {  
            ...
            System.out.println("下载文件-sftp协议      list.get(0)="+list.get(0));
            System.out.println("下载文件-sftp协议      list.get(1)="+list.get(1));
...
//    	ChannelSftp sftp = getSftpConnect("183.62.252.139", 65005, "yilian", "!12345678");  
//        System.out.println("删除完成，开始校验本地文件...");  
//        System.out.println("文件不存在，开始从远程服务器获取...");  
//        download( "/444.xlsx", "D://444.xlsx", sftp);  
...
//        uploadFile(pathString, "/upload/hk", "test.xlsx", sftp);
...
//        exit(sftp);  
    	...
    	ChannelSftp sftp = SftpUtil.getSftpConnect("183.62.242.163", 7222, "fpd", "rabbit-Hitler$fond");
        //ChannelSftp sftp = getSftpConnect("183.62.252.139", 65005, "yilian", "!12345678");
//		System.out.println("开始从远程服务器获取...");  
//		SimpleDateFormat dff = new SimpleDateFormat("yyyy-MM-dd");
//			String path = "D:\\" + "20170815_1000017815_init"+".xlsx";
//			String filePath = "upload/" + "20170815_1000017815_init"+".xlsx";
//			File file = SftpUtil.download(filePath, path, sftp);  
    	SftpUtil.uploadFile("E://YLZF_DZWJ_MONTH_20170823.xlsx", "upload/dz/month", "YLZF_DZWJ_MONTH_20170823.xlsx", sftp);
    }
