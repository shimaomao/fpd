...
public class PDFToImage {
        ...
        try {  
            ...
            for (int i = 0; i < maxPages; i++) {  
               ...
               // bfimage = setGraphics(bfimage);  
                ...
                ImageIO.write(rendImage, "jpg", new File(outputFile+"/"+DateUtils.formatDate(date, "yyyyMMddHHmmss")+"_"+i+".jpg"));  
                bfimage.flush();  
                list.add(outputFile+"/"+DateUtils.formatDate(date, "yyyyMMddHHmmss")+"_"+i+".jpg");  
            }  
        }catch (Exception e) {  
            e.printStackTrace();  
        }  
    ...
    public static BufferedImage setGraphics(BufferedImage bfimage){  
        ...
        //设置旋转  
        g.rotate(-Math.PI/6);  
        g.drawString("创世硅科", 0, (bfimage.getHeight()/2)*1);  
        // 9、释放资源  
        g.dispose();  
        return bfimage;  
    }  
