 ...
 * @version 2016-03-24
 */
public class Gongyu extends DataEntity<Gongyu> {
	
	private static final long serialVersionUID = 1L;
	private String address;		// 房地产地址
	...
	private Double money1;		// 同等房产单位价格1
	private Double money2;		// 同等房产单位价格2
	private Double money3;		// 同等房产单位价格3
	...
	private String dizhiContractId;		// 外键关联抵质押信息表id
	...
	private String beginYearLimit;		// 开始 剩余年限
	private String endYearLimit;		// 结束 剩余年限
	
	public Gongyu() {
		super();
	}

	public Gongyu(String id){
		super(id);
	}

	@Length(min=0, max=255, message="房地产地址长度必须介于 0 和 255 之间")
	...
	@Length(min=0, max=11, message="剩余年限长度必须介于 0 和 11 之间")
	...
	@Length(min=0, max=11, message="外键关联抵质押信息表id长度必须介于 0 和 11 之间")
	...
	public String getBeginYearLimit() {
		return beginYearLimit;
	}

	public void setBeginYearLimit(String beginYearLimit) {
		this.beginYearLimit = beginYearLimit;
	}
	
	public String getEndYearLimit() {
		return endYearLimit;
	}

	public void setEndYearLimit(String endYearLimit) {
