 ...
 */
package com.wanfin.fpd.modules.oa.web;
...
import com.wanfin.fpd.modules.oa.entity.OaNotify;
import com.wanfin.fpd.modules.oa.service.OaNotifyService;
...
public class OaNotifyController extends BaseController {
	...
	public String selfList(OaNotify oaNotify, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		Page<OaNotify> page = oaNotifyService.findRecord(new Page<OaNotify>(request, response), oaNotify); 
		model.addAttribute("page", page);
		return "modules/oa/oaNotifyList";
	}
