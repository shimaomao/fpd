...
<head>
	...
	<script type="text/javascript">
		...
		<%-- 		var $business = $('<div class="control-group"><label class="control-label" for="remarks">关联业务</label></div>');
				...
				$.post("${ctx}/contract/tLoanContract/getLoanContracts",{loanType : 1, status : <%=Cons.LoanContractStatus.TO_REVIEW%>},
						function(list){
						if(list){
				...
				$business.append($('<div class="controls"><div class="input-append"><input id="businessId" name="businessId" value="" type="hidden"><input id="businessName" name="business" readonly="readonly" value="" class="input-large required" onclick="openTreeSelectBox(\'business\',\'businessId\',\'关联业务\',\'\',\'business\',\'\',\'/contract/tLoanContract/treeDataLoanContracts?loanType=1&status=<%=Cons.LoanContractStatus.TO_REVIEW%>\');" type="text"><a id="addressButton" href="javascript:" onclick="openTreeSelectBox(\'business\',\'businessId\',\'关联业务\',\'\',\'business\',\'\',\'/contract/tLoanContract/treeDataLoanContracts?loanType=1&status=<%=Cons.LoanContractStatus.TO_REVIEW%>\');" class="btn">&nbsp;<i class="icon-search"></i>&nbsp;</a>&nbsp;&nbsp;</div><span class="help-inline"><font color="red">*</font></span></div>')).append($('<input type="hidden" name="businessTable" value="t_loan_contract">'));
