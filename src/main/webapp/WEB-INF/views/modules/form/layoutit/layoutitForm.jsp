...
<%@ include file="/WEB-INF/views/include-layoutit/taglib.jsp"%>
<html>
<head>
	<%@ include file="/WEB-INF/views/include-layoutit/head.jsp"%>
</head>
...
<div class="navbar navbar-inverse navbar-fixed-top">
  <div class="navbar-inner">
    <div class="container-fluid">
      ...
      <a class="brand" href="http://justjavac.com/tools/layoutit/"><img src="${ctxStatic}/layoutit/img/favicon.png"> 可视化布局<span class="label">BETA</span></a>
