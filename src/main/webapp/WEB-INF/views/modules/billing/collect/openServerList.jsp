...
<head>
	...
	<script type="text/javascript">
		...
		*/
		...
		function ajaxOpenServer(biRuleId){
			var url = "${ctx}/billing/collect/biCollect/ajaxOpenServer1?biRuleId="+biRuleId;
			location.href = url;
		}
	...
	<div class="box-down" >
		...
		<div class="box group">
		    ...
		    <c:forEach items="${groups}" var="biRule">
			    <c:if test="${biRule.type eq dict.value}">
		            ...
		            <div class="caption">
		              ...
		              <hr/>
		            	...
		            	<div class="text-right">
							<c:if test="${!biRule.hasBuy}"><a href="javascript:void(0);" onclick="ajaxOpenServer('${biRule.id}')" class="btn btn-primary btn-sm">开通服务</a></c:if>
							<c:if test="${biRule.hasBuy}"><a href="javascript:void(0);" class="btn btn-primary btn-sm disabled">已开通服务！</a></c:if>
						</div>
		            </div>
		          </div>
		        </div>
