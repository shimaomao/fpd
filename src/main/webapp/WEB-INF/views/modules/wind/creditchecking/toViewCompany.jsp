					...
					<div class="panel-body">
						<div class="col-md-6">
							<div class="list-group">
							  <div>企业名称：${tCompany.name }</div>
							  <div>企业电话：${tCompany.phone }</div>
							  <div>企业地址：${tCompany.address }</div>
							  <div>证件类型：${tCompany.cardType }</div>
							  <div>证件号码：${tCompany.cardNum }</div>
							  <div>企业性质：${tCompany.properties }</div>
							  <div>成立时间：${tCompany.setupTime }</div>
							</div>
						</div>
						<div class="col-md-6" >
							<div class="list-group">
							  <div>法定代表：${tCompany.surety }</div>
							  <div>法人性别：${tCompany.suretySex }</div>
							  <div>法人年龄：${tCompany.suretyAge }</div>
							  <div>法人生日：${tCompany.suretyBirthday }</div>
							  <div>法人手机：${tCompany.suretyMobile }</div>
							  <div>法人电话：${tCompany.suretyTelephone }</div>
							  <div>法人邮箱：${tCompany.suretyEmail }</div>
							</div>
						</div>
					</div>
				</div>
