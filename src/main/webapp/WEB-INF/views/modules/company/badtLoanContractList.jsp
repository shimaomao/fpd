...
<%--         <li><a href="${ctx}/tcompanyinfo/tCompanyInfor/list?companyId=${tLoanContract.customerId}">财务报告</a></li> --%>
	    ...
	    <li><a href="${ctx}/contract/tLoanContract/clist?customerId=${tLoanContract.customerId}&type=3">业务记录</a></li>
	    <li class="active"><a href="${ctx}/contract/tLoanContract/clist?customerId=${tLoanContract.customerId}&type=4&status=9">不良记录</a></li>
	</ul>
