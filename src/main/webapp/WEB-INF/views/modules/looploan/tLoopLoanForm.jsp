...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/looploan/tLoopLoan/form?id=${data.id}">授信信息<shiro:hasPermission name="looploan:tLoopLoan:edit">${(not empty data.id && fn:contains(data.id, 'new_') == false ) ? '修改' : '添加'}</shiro:hasPermission><shiro:lacksPermission name="looploan:tLoopLoan:edit">查看</shiro:lacksPermission></a></li>
	</ul>
