...
<body>
	<ul class="nav nav-tabs">
		<!-- <li class="active"><a href="javasricpt:void(0);">授信信息</a></li>
		<li><a href="javasricpt:void(0);">申请/审批</a></li> -->
	    <li class="active"><a href="#" onclick="javascript:return false;">授信信息</a></li>
	...
	<div class="nav-tab-con" style="display:none;">
		...
		<form:form id="inputForm" action="${ctx}/act/task/complete" method="post" class="form-horizontal">
			...
			<input type="hidden" name="title" value="授信【${data.loopNumber}】"/>
