...
<!-- <!DOCTYPE html> -->
<%-- <c:set var='nid' value="${empty param.nid ? 'mortgageselect' : param.nid}" /> --%>
...
//                     { name: "number", index: "number", label: "性质", width: 200, hidden: false, search: false, sortable: true}
//                 ],
...
//         		loading('正在保存，请稍等...');
// 				$.post(
// 					'${ctx}/mortgage/mortgageContract/relateContract',
