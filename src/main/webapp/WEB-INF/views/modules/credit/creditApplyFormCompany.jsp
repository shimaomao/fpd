...
<head>
	...
	require(['helper/api'], function(api){
		$(function(){
		    ...
		    var HTCkeditor = CKEDITOR.replace("reportCompany.ftlContent");
...
<body>
	...
	<div id="report" class="nav-tab-con" style="display:none;">
		...
		<form:form id="reportForm" modelAttribute="creditApply" action="${ctx}/credit/creditApply/saveReport" method="post" class="form-horizontal">
			...
			<form:hidden path="reportCompany.id"/>
			<form:hidden path="reportCompany.creditApplyId"/>
			<form:hidden path="reportCompany.tplCode"/>
			<form:hidden path="reportCompany.status"/>
		<div class="control-group">
			<label class="control-label">部门：</label>
			<div class="controls">
				<form:input path="reportCompany.department" htmlEscape="false" maxlength="64" class="input-xlarge required"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="reportCompany.salesman" htmlEscape="false" maxlength="50" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<input name="reportCompany.acceptDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required"
					value="<fmt:formatDate value="${creditApply.reportCompany.acceptDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="control-group">
			...
			<div class="controls">
				<%-- <form:input path="reportCompany.ftlContent" htmlEscape="false" class="input-xlarge "/> --%>
				<textarea id="reportCompany.ftlContent" name="reportCompany.ftlContent" rows="4" maxlength="200" class="input-xxlarge required" >${creditApply.reportCompany.ftlContent }</textarea>
			</div>
		</div>
		<%-- <div class="control-group">
			<label class="control-label">状态：</label>
			<div class="controls">
				<form:select path="reportCompany.status" class="input-xlarge required">
