...
<body>
	...
	<form:form id="inputForm" modelAttribute="cifQhValidate" action="${ctx}/credit/cifQhValidate/searchCredit" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="eductionBckgrd" class="input-xlarge " id="pouseEducation">
					<form:options items="${fns:getDictList('credit_education')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
				</form:select>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">是否真实：</label>
			<form:select path="isHighestEduBkg" class="input-xlarge " id="pouseEducation">
