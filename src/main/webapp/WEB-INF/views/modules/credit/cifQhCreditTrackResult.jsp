...
<body>
	...
	<form:form id="inputForm" modelAttribute="cifQhValidate" action="${ctx}/credit/cifQhValidate/searchCredit" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">基准日期：</label>
			<div class="controls">
				<form:input path="baseDate" htmlEscape="false" maxlength="255" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">基准日期好信度分：</label>
			<div class="controls">
				<form:input path="credooScoreM0" htmlEscape="false" maxlength="255" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">基准日期前推1个月好信度分：</label>
			<div class="controls">
				<form:input path="credooScoreM1" htmlEscape="false" maxlength="255" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">基准日期前推2个月好信度分：</label>
			<div class="controls">
				<form:input path="credooScoreM2" htmlEscape="false" maxlength="255" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">基准日期前推3个月好信度分：</label>
			<div class="controls">
				<form:input path="credooScoreM3" htmlEscape="false" maxlength="255" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">基准日期前推4个月好信度分：</label>
			<div class="controls">
				<form:input path="credooScoreM4" htmlEscape="false" maxlength="255" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">基准日期前推5个月好信度分：</label>
			<div class="controls">
				<form:input path="credooScoreM5" htmlEscape="false" maxlength="255" class="input-xlarge "/>
			</div>
		</div>
