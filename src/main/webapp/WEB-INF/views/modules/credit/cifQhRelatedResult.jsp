...
<body>
	...
	<form:form id="inputForm" modelAttribute="cifQhValidate" action="${ctx}/credit/cifQhValidate/searchCredit" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">关系人姓名：</label>
			<div class="controls">
				<form:input path="refName" htmlEscape="false" maxlength="255" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">关系人手机号：</label>
			<div class="controls">
				<form:input path="refMobileNo" htmlEscape="false" maxlength="255" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">是否真实存在关系：</label>
			<form:select path="isExistRel" class="input-xlarge " id="pouseEducation">
