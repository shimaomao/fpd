...
<head>
	...
	require(['helper/api'], function(api){
		$(function(){
		    ...
		    var HTCkeditor = CKEDITOR.replace("reportEmployee.ftlContent");
...
<body>
	...
	<div id="report" class="nav-tab-con" style="display:none;">
		...
		<form:form id="reportForm" modelAttribute="creditApply" action="${ctx}/credit/creditApply/saveReport" method="post" class="form-horizontal">
			...
			<form:hidden path="reportEmployee.id"/>
			<form:hidden path="reportEmployee.creditApplyId"/>
			<form:hidden path="reportEmployee.tplCode"/>
			<form:hidden path="reportEmployee.status"/>
		<div class="control-group">
			<label class="control-label">部门：</label>
			<div class="controls">
				<form:input path="reportEmployee.department" htmlEscape="false" maxlength="64" class="input-xlarge required"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="reportEmployee.name" htmlEscape="false" maxlength="50" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="reportEmployee.salesman" htmlEscape="false" maxlength="50" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<input name="reportEmployee.acceptDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required"
					value="<fmt:formatDate value="${creditApply.reportEmployee.acceptDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="reportEmployee.creditMoney" htmlEscape="false" class="input-xlarge required number"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="reportEmployee.creditPeriod" htmlEscape="false" maxlength="10" class="input-xlarge  digits"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="reportEmployee.rate" htmlEscape="false" class="input-xlarge required number"/>%
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="reportEmployee.loanMoney" htmlEscape="false" class="input-xlarge required number"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="reportEmployee.loanPeriod" htmlEscape="false" maxlength="10" class="input-xlarge  digits"/>
				月<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="reportEmployee.consultingFee" htmlEscape="false" class="input-xlarge required number"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:radiobuttons path="reportEmployee.repayType" items="${fns:getDictList('product_paytype')}" itemLabel="label" itemValue="value" htmlEscape="false" class=""/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<%-- <form:input path="reportEmployee.businessSource" htmlEscape="false" maxlength="5" class="input-xlarge required"/> --%>
				<form:select path="reportEmployee.businessSource" class="input-xlarge required">
		...
		<div class="control-group">
			...
			<div class="controls">
				<%-- <form:input path="reportEmployee.ftlContent" htmlEscape="false" class="input-xlarge "/> --%>
				<textarea id="reportEmployee.ftlContent" name="reportEmployee.ftlContent" rows="4" maxlength="200" class="input-xxlarge required" >${creditApply.reportEmployee.ftlContent }</textarea>
			</div>
		</div>
		<%-- <div class="control-group">
			<label class="control-label">状态：</label>
			<div class="controls">
				<form:select path="reportEmployee.status" class="input-xlarge required">
					<form:option value="" label=""/>
