...
<head>
	...
	require(['helper/api'], function(api){
		$(function(){
		    ...
		    var HTCkeditor = CKEDITOR.replace("reportPlanted.ftlContent");
...
<body>
	...
	<div id="report" class="nav-tab-con" style="display:none;">
		...
		<form:form id="reportForm" modelAttribute="creditApply" action="${ctx}/credit/creditApply/saveReport" method="post" class="form-horizontal">
			...
			<form:hidden path="reportPlanted.tplCode"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="reportPlanted.creditPeriod" htmlEscape="false" maxlength="10" class="input-xlarge  digits"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="credit:creditApply:edit">
				<input id="reportSubmit" class="btn btn-primary" type="submit" value="保存报告内容"/>&nbsp;
			</shiro:hasPermission>
		</div>
		</c:if>
		<div class="control-group">
