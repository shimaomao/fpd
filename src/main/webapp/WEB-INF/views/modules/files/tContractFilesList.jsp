...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/company/tCompany/form?id=${tContractFiles.taskId}">客户基本信息</a></li>
		<li><a href="${ctx}/tcompanyinfo/tCompanyInfor/list?companyId=${tContractFiles.taskId}">高管\股东\实际控制人\其他人信息</a></li>
		<li><a href="${ctx}/customerrelevan/tCustomerRelevan/list?companyId=${tContractFiles.taskId}">客户关联</a></li>
		<li><a href="${ctx}/customerintent/tCustomerIntent/list?companyId=${tContractFiles.taskId}">意向调查</a></li>
		<li class="active"><a href="${ctx}/files/tContractFiles/list?taskId=${tContractFiles.taskId}&type=customer_archives&mark=1">档案\财务资料</a></li>
<%--         <li><a href="${ctx}/tcompanyinfo/tCompanyInfor/list?companyId=${tContractFiles.taskId}">财务报告</a></li> --%>
        <li><a href="${ctx}/credit/customerCredit/list?customerId=${tContractFiles.taskId}&type=2">授信记录</a></li>
	    <li><a href="${ctx}/contract/tLoanContract/clist?customerId=${tContractFiles.taskId}&type=3">业务记录</a></li>
	    <li><a href="${ctx}/contract/tLoanContract/clist?customerId=${tContractFiles.taskId}&type=4&status=9">不良记录</a></li>
	</ul>
