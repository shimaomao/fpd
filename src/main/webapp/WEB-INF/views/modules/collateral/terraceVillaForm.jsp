...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/collateral/terraceVilla/">抵押联排别墅列表</a></li>
		<li class="active"><a href="${ctx}/collateral/terraceVilla/form?id=${terraceVilla.id}">抵押联排别墅<shiro:hasPermission name="collateral:terraceVilla:edit">${not empty terraceVilla.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="collateral:terraceVilla:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="terraceVilla" action="${ctx}/collateral/terraceVilla/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="jyear" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${terraceVilla.jyear}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="form-actions">
			<shiro:hasPermission name="collateral:terraceVilla:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
