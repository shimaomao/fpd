...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/collateral/gongyu/">抵押公寓信息列表</a></li>
		<li class="active"><a href="${ctx}/collateral/gongyu/form?id=${gongyu.id}">抵押公寓信息<shiro:hasPermission name="collateral:gongyu:edit">${not empty gongyu.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="collateral:gongyu:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="gongyu" action="${ctx}/collateral/gongyu/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="jyear" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${gongyu.jyear}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="yearLimit" htmlEscape="false" maxlength="11" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="collateral:gongyu:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
