...
<body>
	...
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/info" method="post" class="form-horizontal"><%--
		...
		<form:hidden id="id" path="id" htmlEscape="false" maxlength="255" class="input-xlarge"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<label class="lbl">${fns:getDictLabel(user.company.primaryPerson, 'company_type', '无')}公司</label>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<label class="lbl">${fns:getDictLabel(user.phone, 'sys_user_level', '无')}</label>
			</div>
		</div>
		<div class="control-group">
