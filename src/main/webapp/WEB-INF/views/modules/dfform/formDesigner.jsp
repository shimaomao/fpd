...
<head>
    ...
    <link href="${ctxStatic}/bootstrap/2.2.2/css/bootstrap.css" rel="stylesheet" type="text/css" />
    <!--[if lte IE 6]>
    ...
    <![endif]-->
    <link href="${ctxStatic}/css/site.css" rel="stylesheet" type="text/css" />
</head> --%>
<%@ page contentType="text/html;charset=UTF-8" %>
...
<script type="text/javascript" charset="utf-8" src="${ctxStatic}/ueditor/formdesign/formdesign.v4.js"></script>
<!-- script start-->
...
var formEditor = UE.getEditor('formEditor',{
    ...
    //,iframeCssUrl:"${ctxStatic}/form/builder/assets/css/lib/bootstrap.min.css" //引入自身 css使编辑器兼容你网站css
...
var formDesign = {
    ...
    fnCheckForm : function ( type ) {
        ...
        if(formEditor.hasContents()){
            ...
            $.ajax({
                type: 'POST',
                url : '${ctx}/dfform/form/processor',
                //dataType : 'json',
                data : {'type' : type_value,'formid':'${form.id}','parse_form':parse_form},
                success : function(data){
					if(data == true) {
						alert('表单保存成功');
						window.location.href='${ctx}/dfform/form';
					} else {
						alert('表单保存失败');
					}
                }
