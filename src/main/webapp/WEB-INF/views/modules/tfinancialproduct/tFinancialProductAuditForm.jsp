	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#btnSubmit").click(function(){
				var yesOrNo = getCheckValue("yesOrNo");
				if(confirm("确定要提交审核？")){
				 }else{
					 return false;
				 }
...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/tfinancialproduct/tFinancialProduct/duditform?id=${tFinancialProduct.id}">理财产品审核</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="tFinancialProduct" action="${ctx}/tfinancialproduct/tFinancialProduct/auditsave" method="post" class="form-horizontal" >
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:radiobuttons path="yesOrNo" id="yesOrNo" items="${fns:getDictList('yes_no')}" itemLabel="label" itemValue="value" htmlEscape="false" class=""/>
			</div>
		</div>
		<div class="control-group">
