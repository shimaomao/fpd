...
<body>
    <ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/db/oldcaiWu/form">导入担保报表</a></li>
	</ul><br/> 
	
	<form:form id="mainForm" name="mainForm" action="${ctx}/db/oldcaiWu/save" enctype="multipart/form-data" method="post" >
