...
<title>易联支付跨境账户系统</title>
	...
	<!--独立的js-->
	<script src="${pageContext.request.contextPath}/static/wish/js/gathering.js"></script>
	...
	<div class="inner">
		<div class="title">
			...
			<div class="deal-footer">
				<form class="vform" action="${pageContext.request.contextPath}/wish/author/applyOpen" method="post">
				<p class="p-text deal-title">请仔细阅读上述《易联秒收货款服务协议》，并严格遵守。若同意该服务协议，请您耐心输入以下文字：</p>
				<p class="p-text p-color"><img src="${pageContext.request.contextPath}/static/wish/img/msg.png" alt=""></p>
				<div>
					<input type="text" class="ipt02 w_70" datatype="checkMsg" nullmsg="请填写以上信息！">
				</div>
				<p class="p-text p-color mt_20 mb_0">请输入您商户账号的认证材料，以便我们确认此次操作是由您本人完成。</p>

					<div class="formrow">
						<p class="fl w_10 f_title">账户姓名</p>
						<p class="fl w_80 f_input">
							<input type="text" name="userName" datatype="s1-48" class="ipt02 w_30" nullmsg="请填写信息！">
							<span class="Validform_checktip"></span></p>
					</div>
					<div class="formrow">
						<p class="fl w_10 f_title">身份证号</p>
						<p class="fl w_80 f_input">
							<input type="text" name="identityNum" datatype="idcard" errormsg="您填写的身份证号码不对！" class="ipt02 w_30" nullmsg="请填写信息！">
							<span class="Validform_checktip"></span></p>
					</div>
					<div class="formrow">
						<p class="fl w_10 f_title">银行卡卡号</p>
						<p class="fl w_80 f_input">
							<input type="text" name="accountNum" datatype="checkBank" errormsg="您填写的银行卡卡号不对！" class="ipt02 w_30" nullmsg="请填写信息！">
							<span class="Validform_checktip"></span></p>
					</div>
					<div class="formrow">
						<p class="fl w_10 f_title">手机号</p>
						<p class="fl w_80 f_input">
							<input type="text" name="phone" datatype="m" class="ipt02 w_30" errormsg="手机格式不正确"  nullmsg="请填写信息！">
							<span class="Validform_checktip"></span></p>
					</div>
					<div class="formrow">
						<p class="fl w_10 f_title">
							<label>短信验证码</label>
						</p>
						<p class="fl w_80 f_input">
							<input name="smscode" id="smscode" type="text" value="" class="ipt02" datatype="s1-10"> <input name="sm_id" id="sm_id" type="hidden" value=""> <input type="button" class="btn02" id="getsmcode" value="获取验证码" onclick="getSmCode()">
							<span class="Validform_checktip"></span></p>
					</div>
					<div class="clear"></div>
					<div class="btnrow" style="text-align: center">
							<input id="parentIframe" class="btn01" name="" type="submit" value="我已阅读并同意遵守上述协议">
					</div>
				</form>
			</div>
	</div>
