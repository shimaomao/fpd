		...
		<div class="inner">
			<div class="apply-result clearfix">
				...
				<div class="right-cont fl">
					<p class="title-t sh-item">您的身份认证不成功!</p>
					<p class="tip tip2">请检查身份信息填写是否有误，再重新申请认证。</p>
				</div>
			</div>
		</div>
	</div>
	...
	<div id="footer" class="outside footer">
		<div class="level01">
			<div class="h_inner">
				...
				<div class="fr">易联支付有限公司©版权所有&nbsp;&nbsp;ICP证：<a href="${pageContext.request.contextPath}/static/web/images/certificate/zzdx.jpg" target="_black" class="icp">粤B2-20120038</a> | <a href="http://payeco.com/images/certificate/zzdx.jpg" target="_black" class="icp">B2-20110256</a></div>
			</div>
		</div>
		<div class="level02">
			<div class="h_inner">
