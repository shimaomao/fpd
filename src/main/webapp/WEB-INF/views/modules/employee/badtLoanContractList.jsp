...
<body>
  	<ul class="nav nav-tabs">
		...
		<li><a href="${ctx}/contract/tLoanContract/clist?customerId=${tLoanContract.customerId}&type=1">业务记录</a></li>
		<li class="active"><a href="${ctx}/contract/tLoanContract/clist?customerId=${tLoanContract.customerId}&type=2&status=9">不良记录</a></li>
	</ul>
