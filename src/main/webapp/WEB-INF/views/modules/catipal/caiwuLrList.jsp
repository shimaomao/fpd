...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/catipal/tCaiwu/listLr">小贷利润表列表</a></li>
		<li><a href="${ctx}/catipal/tCaiwu/form?informFilingType=2">小贷利润表添加</a></li>
	</ul>
		...
		<c:forEach items="${page.list}" var="tCaiwu">
			<tr>
				...
				<shiro:hasPermission name="catipal:tCaiwu:edit"></shiro:hasPermission><td>
    				<a href="${ctx}/catipal/tCaiwu/form?informFilingType=2&id=${tCaiwu.id}">修改</a>
